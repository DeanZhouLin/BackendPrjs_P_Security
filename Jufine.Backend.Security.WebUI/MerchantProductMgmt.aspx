<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="True" CodeBehind="MerchantProductMgmt.aspx.cs" Inherits="Jufine.Backend.Security.WebUI.MerchantProductMgmt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="edit_bar">
            <table style="width: 100%;" class="search_table">
                <tr>
                    ...
                    <td style="width: 80px;">MerchantID
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 80px;">CommonNO
                    </td>
                    <td>
                        <asp:TextBox ID="stxtCommonNO" PropertyName="CommonNO" Width="300" runat="server"></asp:TextBox>
                    </td>

                    <td style="width: 80px;">Type
                    </td>
                    <td>
    ...
    <asp:UpdatePanel ID="upList" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            <asp:GridView ID="gvMerchantProductList"
                runat="server"
                OnSorting="gvMerchantProductList_Sorting"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CommonNO" HeaderText="CommonNO" SortExpression="CommonNO" ItemStyle-Width="60" />
                            ...
                            <div class="c1">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCommonNO" PropertyName="CommonNO" MaxLength="10" Width="200" runat="server"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMemo" PropertyName="Memo" MaxLength="4000" Width="200" runat="server"></asp:TextBox>
                                        </td>
